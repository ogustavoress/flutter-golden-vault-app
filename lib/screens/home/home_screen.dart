...
import 'package:checkpoint3_550983_552041/screens/password/new_password_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  String formatarNome(String email) {
    String nome = email.split('@').first;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          "Bem-vindo, ${formatarNome(user.email!)}",
