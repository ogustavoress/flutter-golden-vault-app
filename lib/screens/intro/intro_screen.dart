...
class _IntroScreenState extends State<IntroScreen> {
  ...
  final List<Map<String, dynamic>> pages = [
    {
      "title": "Golden Vault",
      "subtitle": "Guarde suas senhas com luxo e proteção máxima.",
      "lottie": "assets/lottie/intro.json"
    },
    {
      "title": "Acesso Exclusivo",
      "subtitle": "Controle absoluto com criptografia digna da realeza.",
      "lottie": "assets/lottie/login.json"
    },
    {
      "title": "Cofre Premium",
      "subtitle": "O lugar mais seguro do universo para seus segredos.",
  ...
  void _finishIntro() async {
    if (_dontShowAgain) {
      await PrefsService.disableIntro();
    }
