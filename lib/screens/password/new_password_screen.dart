...
import 'package:checkpoint3_550983_552041/widgets/password_result_widget.dart';
  ...
  Future<void> generatePassword() async {
    ...
    if (chars.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Selecione uma opção para gerar a senha."),
    ...
    for (int i = 0; i < length.toInt(); i++) {
      int index = (random + i * DateTime.now().millisecond) % chars.length;
      ...
      builder: (_) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: const InputDecoration(
            hintText: "Ex: Netflix, Banco, Wi-Fi...",
